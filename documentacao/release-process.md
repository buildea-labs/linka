...
5. O workflow **Deploy to TestFlight** é disparado manualmente na `main`, passa pelo ambiente protegido `testflight` e recusa qualquer SHA que não seja a ponta atual da main.
