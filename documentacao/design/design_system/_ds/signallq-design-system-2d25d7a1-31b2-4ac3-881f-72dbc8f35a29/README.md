...
52 CSS custom properties from @signallq/design-system. Names are
preserved verbatim from upstream. They are declared inside `_ds_bundle.css` (this DS ships one compiled stylesheet rather than separate token files).

- **color** (12): `--bg-primary`, `--bg-secondary`, `--bg-card`, …
- **spacing** (8): `--space-xs`, `--space-sm`, `--space-md`, …
- **typography** (1): `--font-sans`
- **radius** (6): `--radius-card`, `--radius-button`, `--radius-field`, …
- **shadow** (4): `--depth-level0-shadow`, `--depth-level1-shadow`, `--depth-level2-shadow`, …
- **other** (21): `--accent`, `--on-accent`, `--accent-blue`, …
...
- `Card` — Surface card: separao do fundo por profundidade (tint de superfcie, nvel 1), sem borda.
