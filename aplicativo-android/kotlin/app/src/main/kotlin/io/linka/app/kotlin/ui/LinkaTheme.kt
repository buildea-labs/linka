...
object LkColors {
    ...
    // ── Orbit / Linka IA screen palette (always-dark, independent of theme) ──
    /** Fundo primário da tela Linka IA — preto levemente arroxeado. */
    val linkaBlack = Color(0xFF0D0D1A)
    /** Gradiente superior da tela Linka IA — roxo escuro profundo. */
    val linkaDarkSurface = Color(0xFF1A0B2E)
    /** Superfície de cards da tela Linka IA. */
    val linkaDarkCard = Color(0xFF1E1130)
    /** Texto primário sobre fundos escuros da tela Linka IA. */
    val linkaTextOnDark = Color(0xFFF3F4F6)
    /** Texto secundário sobre fundos escuros da tela Linka IA. */
    val linkaTextSecondaryOnDark = Color(0xFF9CA3AF)
