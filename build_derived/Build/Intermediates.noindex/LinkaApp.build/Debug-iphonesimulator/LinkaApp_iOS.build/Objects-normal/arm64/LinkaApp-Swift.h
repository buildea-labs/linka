...
#ifndef LINKAAPP_SWIFT_H
#define LINKAAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LinkaApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8LinkaApp14NativeAdLoader")
...
@class GADAdLoader;
@class GADNativeAd;
@interface NativeAdLoader (SWIFT_EXTENSION(LinkaApp)) <GADNativeAdLoaderDelegate>
